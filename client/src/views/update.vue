<template>
  <div class="container">
    <form @submit.prevent="update">
      ...
      <b-button class="mt-3" variant="outline-secondary" block type="submit" >Update Question</b-button>
    </form>
  </div>
</template>
  ...
  watch: {
    $route(to, from) {
      if(to === '/update/'){
        ...
        this.content = this.findById.description
        this.tags = this.findById.tags
      }
    }
  },
  created () {
